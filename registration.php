                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="">
                                    <h3 class="text-center font-weight-light my-4">e-Diary System</h3>
                                </div>
                                <h3 class="text-center font-weight-light text-primary my-4">User Registration</h3>
                                <div class="card-body">
                                    <form method="post" name="registration" onSubmit="return valid();">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputEmail" type="text"
                                                placeholder="Enter yout mobile number" name="mobileno" maxlength="10"
                                                pattern="[0-9]+">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="inputPassword" type="password"
                                                        placeholder="Create a password" name="newpassword"
                                                        id="newpassword" />
